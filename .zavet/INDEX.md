...
- **D-0018** — The offline timeline is a port of the cloud's grouping, pinned by a shared fixture (active)
<!-- zavet:decisions:end -->
...
<!-- zavet:specs:start -->
- **attestation-sync** — Attestation sync and session rollups (session, high, 2026-07-31)
- **capture-pipeline** — Zavet capture pipeline (session, high, 2026-07-16)
- **daemon-lifecycle** — Daemon startup and ingress lifecycle (session, high, 2026-07-31)
