...
- **cloud-runtime** — Cloud agent runtimes (teleport) (session, high, 2026-09-02)
...
- **doctor** — Diagnostics — dira doctor and the capture probe (session, high, 2026-09-02)
...
- **onboarding** — Onboarding — dira onboard and the installer handoff (session, high, 2026-09-09)
<!-- zavet:specs:end -->
